...
<main>
  ...
  $sql = "SELECT usuarios.usuario_id, usuarios.nombre, usuarios.apellido, usuarios.username, usuarios.password,  usuarios.correo, roles.rol_nombre 
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            <tr>
              ...
              <td data-label="Acciones">
                <div>
                  <?php $usuario_id = encryptor('encrypt', $row['usuario_id']) ?>
                  <a href='edit.php?id=<?php echo $usuario_id; ?>'>
                  ...
                  <a href='modal.php?id=<?php echo $usuario_id; ?>'>
